...
test("offscreen scanner is WebRTC-only and has no App Clip relay session path", () => {
  ...
  assert.doesNotMatch(offscreenSource, /startAppClipRelay/);
  assert.doesNotMatch(offscreenSource, /scannerOffscreenStartAppClipRelay/);
